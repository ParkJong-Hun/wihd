...
import co.kr.parkjonghun.whatishedoingwithandroid.ui.web.LoadingState.Finished
import co.kr.parkjonghun.whatishedoingwithandroid.ui.web.LoadingState.Loading
...
fun WebView(
    ...
    client: WihdWebViewClient = remember { WihdWebViewClient() },
    chromeClient: WihdWebChromeClient = remember { WihdWebChromeClient() },
...
class WebViewNavigator(private val coroutineScope: CoroutineScope) {
    ...
    suspend fun WebView.handleNavigationEvents(): Nothing = withContext(Dispatchers.Main) {
